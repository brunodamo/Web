...
public class ServletJSTL extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pb.insertPessoa(request.getParameter("nome"), 
				Integer.parseInt(request.getParameter("idade")), 
				request.getParameter("sexo").charAt(0)) == true){
			
			request.setAttribute("lista", pb.listaPessoa());
...
//		
//		//Populando o objeto com os parâmetros do request
...
//		
//		//Colocando um atributo na sessão
...
//
//		///Criando o atributo no request que será enviado para o alvo!
